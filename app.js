new fullpage("#fullpage", {
    ...
    onLeave: function (origin, destination, direction) {
        ...
        if (window.innerHeight > window.innerWidth){
            tl.from(".view-container", { delay: 0.6, opacity: 0, x: "-100%", ease: "expo.out" });
...
let burger = document.getElementById("burger").addEventListener("click", () => {
    if (i == "OFF") {
        ...
        // menu.to('#burger-box', .5, {  ease: Expo.easeOut })
        // menu.to('#burger-box', .5, {  ease: Expo.easeOut })
        ...
        // gsap.to('#burger-box', 1, { backdropFilter: 'blur(0)', ease: Expo.easeOut })
        // gsap.to('#burger-box', 1, { width: '0', ease: Expo.easeOut })
